...
import { Building2, TrendingUp, Users, Eye, MoreVertical } from "lucide-react";
      ...
      <CardContent className="space-y-4">
        {buildings.map((building, index) => {
          ...
          return (
            <div
              key={building.id}
              className="group relative glass-card rounded-xl p-4 lg:p-6 border border-border/40 hover:border-primary/40 transition-all duration-500 hover:-translate-y-1"
